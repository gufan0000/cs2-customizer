...
<!-- 待补：以下三段录屏尚未录制，欢迎 PR 补充到 docs/images/ -->

| 准心跟随 | 击杀音效触发 | 搜索定位高亮 |
| --- | --- | --- |
| ![准心叠加层跟随游戏窗口](docs/images/crosshair-follow.gif) | ![击杀触发音效与图标动画](docs/images/kill-sound-trigger.gif) | ![搜索直接高亮到具体设置项](docs/images/search-highlight.gif) |

建议录制这三段（各 5–8 秒，GIF 或 WebM）：
