...
#: 退避重试（RN-613，批 84 搬到 `io_validation`，全仓共用一份）。
#: 为什么需要它、那 8% 是怎么量的、为什么这个文件曾经自带一份 —— 全在那边的模块注释里。
from core.io_validation import replace_with_retry as _replace_with_retry
