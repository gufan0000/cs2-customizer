...
SEARCH_INDEX: List[Tuple[str, str, List[str]]] = [
    ...
    ("special_sound", "特殊音效", [
        ...
        "拆除", "拆弹", "拆包音效", "爆炸", "炸了", "C4爆炸", "包爆了",
        "比赛开始", "比赛结束", "开局音效", "半场", "换边", "交换阵营",
        "提醒间隔", "冷却", "别一直响", "太吵",
        "grenade", "smoke", "bomb", "low hp", "health", "defuse", "defused", "explode",
    ]),
    ("crosshair", "准心设置", [
        "准心", "准星", "十字准心", "十字", "瞄准点", "看不见准星", "准星不见", "准心不见了", "没准心",
        "准心颜色", "准星颜色", "准心大小", "准心粗细", "描边", "动态准心", "击杀联动", "击杀变色",
        "导入准心", "分享准心", "准心样式", "自定义准星", "分享码", "准心代码", "准心分享码",
        "中心间隙", "间隙", "中间留空", "准心挡住", "挡住准星点", "中心点", "小点",
        "黑边", "黑色描边", "描边粗细", "看不清准星", "亮地板", "透明度", "不透明度", "半透明",
        "自定义颜色", "取色", "调色", "任意颜色", "RGB",
        "crosshair", "crosshairs", "reticle", "aim", "gap", "outline", "dot", "alpha",
    ]),
    ("kill_icon", "击杀图标", [
        "击杀图标", "连杀图标", "图标", "图案", "击杀提示", "图标动画", "sprite", "精灵图", "FPS",
        "图标位置", "图标大小", "图标缩放", "击杀动画", "kill icon", "icon",
        # KI-2/KI-3 新增的入口与参数。用户找导入功能时嘴里说的是"动图"和格式名，
        # 不是"精灵图"——这批词是照着"用户真会怎么打字"补的。
        "导入动图", "导入图标", "自定义图标", "换图标", "gif", "webp", "apng", "动图",
        "表情包", "拖进来", "拖拽导入", "帧序列", "素材",
        "展示时长", "显示多久", "停留时间", "播放速度", "太快了", "太慢了",
        "淡入淡出", "渐隐", "爆头图标", "爆头专用", "位置示意图", "图标预览",
        # KI-4/KI-6：分发单位从"单个等级"变成"一整套风格"，入口也从对话框
        # 搬到了清单板上。用户找这些东西时嘴里说的是"图标包""换成别人的"。
        "图标包", "导入图标包", "导出图标包", "分享图标", "zip", "压缩包", "整套",
        "素材清单", "缺哪个等级", "删除图标", "撤销", "恢复",
        "静态图片", "不动的图", "定格", "停多久",
        "抠背景", "去背景", "黑底", "白边", "裁边", "透明边",
        "aseprite", "图集行列", "切图", "mp4", "视频",
    ]),
    ("viewmodel", "局内视角", [
        "视角", "局内视角", "viewmodel", "手模", "持枪视角", "枪的位置", "手臂位置", "FOV", "视野",
        "自动切换", "循环视角", "视角预设", "手模位置", "第一视角", "view model", "field of view", "拉近", "拉远", "枪往前", "枪往后",
        "准心回正", "快速回正", "准星跟随", "跟随后坐力", "开火键", "副开火键", "改了开火键",
        "仅自己可见", "队友看不到", "录像看不到",
    ]),
    ("magnifier", "开镜放大", [
    ...
    ("audio_import_wizard", "导入资源", [
        ...
        # ⭐ 旧显示名留作别名：用户搜"向导"还得搜得到（2026-09-16 改名）。
        "资源导入向导", "向导",
        # 2026-09-16 统一导入之后新增的能力，各给一条搜得到的说法。
        "压缩包", "zip", "解压", "安装素材", "装素材", "导入图标", "导入准心",
    ]),
