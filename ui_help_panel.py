...
PAGE_HELP_TEXTS = {
    ...
    "kill_sound": (
        ...
        "<b>自定义音效</b><br>"
        "1. 打开目录 <code>AppData/Local/FanTool/resources/audio/kill_sounds/</code><br>"
    ...
    "kill_voice": (
        ...
        "<b>自定义语音</b><br>"
        "1. 打开目录 <code>AppData/Local/FanTool/resources/audio/kill_voices/</code><br>"
        "2. 在对应武器文件夹中创建自定义风格文件夹<br>"
        "3. 放入 MP3/WAV/OGG 格式的音频文件（按击杀数命名：1、2 ...）<br>"
        "4. 文件夹名称会自动显示在下拉菜单中"
    ),
    "kill_icon": (
        ...
        "<b>自定义图标</b><br>"
        "1. 在 <code>AppData/Local/FanTool/resources/kill_icons/</code> 创建风格文件夹<br>"
    ...
    "death_sound": (
        ...
        "<b>自定义音效</b><br>"
        "1. 打开目录 <code>AppData/Local/FanTool/resources/audio/death/</code><br>"
    ...
    "gun_sound": (
        ...
        "<b>自定义枪声</b><br>"
        "1. 打开目录 <code>AppData/Local/FanTool/resources/audio/gun_sounds/</code><br>"
        "2. 在对应武器文件夹中创建自定义风格文件夹<br>"
    ...
    "switch_weapon": (
        ...
        "3. 点击「测试」按钮可预听当前选择的音效<br><br>"
        "<b>自定义音效</b><br>"
        "1. 打开目录 <code>AppData/Local/FanTool/resources/audio/switch_weapons/</code><br>"
        "2. 创建自定义风格文件夹，放入 MP3/WAV/OGG 格式的音频文件<br>"
        "3. 文件夹名称会自动显示在下拉菜单中"
    ),
    "reload_sound": (
        ...
        "3. 点击「测试」按钮可预听当前选择的音效<br><br>"
        "<b>自定义音效</b><br>"
        "1. 打开目录 <code>AppData/Local/FanTool/resources/audio/reload_sounds/</code><br>"
        "2. 创建自定义风格文件夹，放入 MP3/WAV/OGG 格式的音频文件<br>"
        "3. 文件夹名称会自动显示在下拉菜单中"
    ),
    "special_sound": (
...
"3. 为每个事件选择音效风格<br>"
        ...
        "<b>自定义音效</b><br>"
        "各类音效的自定义目录均在 <code>AppData/Local/FanTool/resources/audio/</code> 下：<br>"
    ...
    "viewmodel": (
        ...
        "2. CFG 文件会写入 CS2 目录下的 <code>game/csgo/cfg/fanpai.cfg</code><br>"
        "3. 游戏内打开控制台输入 <code>exec fanpai.cfg</code> 加载配置<br>"
    ...
    "magnifier": (
        ...
        "• 灵敏度联动会写入 <code>fanpai.cfg</code> 和 <code>fanpai_magnifier_runtime.cfg</code><br>"
        "• 当前游戏会话首次启用灵敏度联动时，如未生效，请在控制台执行一次 <code>exec fanpai.cfg</code>"
    ),
    "flash": (
        "<b>功能说明</b><br>"
        ...
        "<b>自定义素材</b><br>"
        "• 闪光图片：支持 PNG/JPG 格式，放入 <code>AppData/Local/FanTool/resources/flash_images/</code> 目录<br>"
        "• 闪光音效：支持 MP3/WAV/OGG 格式，放入 <code>AppData/Local/FanTool/resources/flash_audio/</code> 目录"
    ),
    "music": (
        "<b>功能说明</b><br>"
    ...
    "hud_color": (
        ...
        "<b>数字键颜色（纯 CFG）</b><br>"
        "数字键 1-9 的颜色映射写入 fanpai.cfg，软件关闭时仍可用。<br>"
        ...
        "<b>保存与生效</b><br>"
        "1. 点击「保存 HUD 规则」<br>"
        "2. 游戏内输入 <code>exec fanpai.cfg</code><br>"
        "3. 运行软件后事件响应自动生效"
    ),
    "advanced": (
        "<b>功能说明</b><br>"
...
PAGE_HELP_TEXTS.update({
    "basic": (
        ...
        "<b>文件与配置位置</b><br>"
        "1. 本页无需手动放资源文件。<br>"
        "2. 基础开关、音量、主题等设置保存在 <code>AppData/Local/FanTool/config.json</code>。<br>"
        "3. 音效、图片、图标等素材统一放在 <code>AppData/Local/FanTool/resources/</code> 下，具体子目录请看各功能页右上角问号说明。<br><br>"
        "<b>注意事项</b><br>"
        "• 部分功能需要先在「高级设置」中配置 CS2 目录才能正常工作<br>"
        "• 音效类功能需要 GSI 服务正常运行（软件启动时自动配置）<br>"
        "• 关闭总开关会同时停止该功能的所有音效播放"
    ...
    "advanced": (
        ...
        "<b>文件与配置位置</b><br>"
        "1. 本页无需手动放素材文件。<br>"
        "2. 你选择的 CS2 目录会写入 <code>AppData/Local/FanTool/config.json</code>。<br>"
        "3. 软件会自动在 <code>CS2/game/csgo/cfg/gamestate_integration_fanpai.cfg</code> 生成或更新 GSI 配置文件。<br>"
        "4. 其他需要写入游戏的功能（如视角、HUD、灵敏度联动）会在同一目录下生成 <code>fanpai.cfg</code> 等文件。<br><br>"
        "<b>GSI 状态</b><br>"
        "GSI（Game State Integration）是 CS2 提供的游戏状态接口，软件通过它获取击杀、死亡、武器切换等事件。状态显示为绿色表示正常运行。<br><br>"
        "<b>注意事项</b><br>"
        "• 修改 CS2 目录后建议重启软件<br>"
    ...
    "crosshair": (
        ...
        "2. 自定义准心导入 / 导出的默认目录为 <code>AppData/Local/FanTool/resources/crosshair/</code>。<br>"
        "3. 导出的文件格式为 <code>.xchr</code>；导入成功后会写回 <code>AppData/Local/FanTool/config.json</code>。<br><br>"
        "<b>注意事项</b><br>"
        "• 准心为屏幕覆盖层，不会被游戏检测<br>"
    ...
    "kill_sound": (
        ...
        "4. 点击「测试」按钮可预听当前选择的音效<br><br>"
        "<b>自定义音效目录</b><br>"
        "1. 通用连杀风格放在 <code>AppData/Local/FanTool/resources/audio/kill_sounds/风格名/</code><br>"
        "2. 武器专属风格放在 <code>AppData/Local/FanTool/resources/audio/weapon_kill_sounds/武器名/风格名/</code><br>"
    ...
    "kill_voice": (
        ...
        "4. 点击「测试」按钮可预听当前选择的语音<br><br>"
        "<b>自定义语音目录</b><br>"
        "1. 通用语音风格放在 <code>AppData/Local/FanTool/resources/audio/kill_voices/风格名/</code><br>"
        "2. 武器专属语音风格放在 <code>AppData/Local/FanTool/resources/audio/weapon_kill_voices/武器名/风格名/</code><br>"
    ...
    "kill_icon": (
        ...
        "4. 点击「预览」查看动画效果<br><br>"
        "<b>格式要求与目录</b><br>"
        "1. 每套风格放在 <code>AppData/Local/FanTool/resources/kill_icons/风格名/</code><br>"
    ...
    "death_sound": (
        ...
        "2. 直接把文件放到 <code>AppData/Local/FanTool/resources/audio/death/</code><br>"
    ...
    "gun_sound": (
        ...
        "<b>自定义枪声目录</b><br>"
        "1. 每把武器的目录结构为 <code>AppData/Local/FanTool/resources/audio/gun_sounds/武器名/风格名/</code><br>"
    ...
    "switch_weapon": (
        ...
        "3. 点击「测试」按钮可预听当前选择的音效<br><br>"
        "<b>自定义音效目录</b><br>"
        "1. 目录结构为 <code>AppData/Local/FanTool/resources/audio/switch_weapons/武器名/风格名/</code><br>"
    ...
    "reload_sound": (
        ...
        "3. 点击「测试」按钮可预听当前选择的音效<br><br>"
        "<b>自定义音效目录</b><br>"
        "1. 目录结构为 <code>AppData/Local/FanTool/resources/audio/reload_sounds/武器名/风格名/</code><br>"
        "2. 风格文件夹里放 1 个或多个 MP3/WAV/OGG 文件即可<br>"
        "3. 放完后点击「刷新风格列表」，对应武器会显示新的风格"
    ),
    "special_sound": (
        ...
        "4. 点击「测试」按钮预听效果<br><br>"
        "<b>自定义音效目录</b><br>"
        "所有目录都在 <code>AppData/Local/FanTool/resources/audio/</code> 下：<br>"
        "• 投掷物：<code>grenade_sounds/投掷物类型/风格名/throw.mp3</code><br>"
        "• C4：<code>c4_sounds/风格名/planted.mp3</code><br>"
        "• 血量警告：<code>health_warning/风格名/warning.mp3</code><br>"
    ...
    "viewmodel": (
        ...
        "<b>文件与生效位置</b><br>"
        "1. 这个功能无需额外放素材文件。<br>"
        "2. 页面参数保存在 <code>AppData/Local/FanTool/config.json</code>。<br>"
        "3. 点击「保存设置到CFG」后，会写入 <code>CS2/game/csgo/cfg/fanpai.cfg</code>（<b>需先在「高级设置」里配置好 CS2 目录，否则保存会失败</b>）<br>"
        "4. 游戏内输入 <code>exec fanpai.cfg</code> 可立即加载；如需自动加载，可把这句写进 <code>autoexec.cfg</code>"
    ),
    "magnifier": (
        "<b>功能说明</b><br>"
        ...
        "<b>文件与生效位置</b><br>"
        "1. 这个功能无需额外放素材文件。<br>"
        "2. 参数保存在 <code>AppData/Local/FanTool/config.json</code>。<br>"
        "3. 灵敏度联动会生成 <code>CS2/game/csgo/cfg/fanpai.cfg</code> 和 <code>CS2/game/csgo/cfg/fanpai_magnifier_runtime.cfg</code><br>"
        "4. 当前游戏会话首次启用联动时，如未生效，请在控制台执行一次 <code>exec fanpai.cfg</code><br><br>"
        "<b>注意事项</b><br>"
        "• 此功能需要以管理员身份运行程序<br>"
    ...
    "flash": (
        ...
        "<b>自定义素材目录</b><br>"
        "1. 图片风格目录：<code>AppData/Local/FanTool/resources/flash_images/风格名/</code><br>"
        "2. 同一套 PNG/JPG 图片放进对应风格文件夹后，点击「刷新样式列表」即可出现<br>"
        "3. 音频风格目录：<code>AppData/Local/FanTool/resources/flash_audio/风格名/</code><br>"
    ...
    "music": (
        ...
        "2. 播放列表、当前曲目、播放进度和联动规则保存在 <code>AppData/Local/FanTool/config.json</code>。<br>"
    ...
    "voice_output": (
        ...
        "3. 槽位、快捷键、PTT 和模式等设置保存在 <code>AppData/Local/FanTool/config.json</code>。<br>"
        "4. 如果需要备份 / 迁移，导出配置默认建议保存为 <code>AppData/Local/FanTool/voice_output_config.json</code><br><br>"
        "<b>各模块说明</b><br>"
    ...
    "utility": (
        ...
        "4. 用数字键 1-9 选择道具，数字键 0 返回上级，ESC 关闭<br><br>"
        "<b>文件夹结构</b><br>"
        "道具图片统一放在 <code>AppData/Local/FanTool/resources/utility_guides/</code> 下：<br>"
        "<code>地图名/T或CT/分类名/道具名_站位.jpg + 道具名_瞄准.jpg</code><br>"
        "例如：<code>AppData/Local/FanTool/resources/utility_guides/de_dust2/T/A点进攻/Xbox烟_站位.jpg</code><br><br>"
        "<b>自定义道具</b><br>"
        "1. 在对应地图的 T 或 CT 文件夹下创建分类文件夹<br>"
        "2. 添加成对的图片（站位图 + 瞄准图），命名格式为「道具名_站位」和「道具名_瞄准」<br>"
        "3. 支持 JPG/PNG 格式，点击「刷新道具列表」即可加载"
    ...
    "hud_color": (
        ...
        "HUD 颜色规则让你的 HUD 根据游戏事件自动变色。选一个预设方案，开关你想要的事件即可。<br><br>"
        "<b>数字键颜色（纯 CFG）</b><br>"
        "数字键 1-9 的颜色映射写入 fanpai.cfg，软件关闭时仍可用。游戏中按数字键切换武器时会同时切换 HUD 颜色。<br><br>"
        "<b>事件响应（需软件）</b><br>"
        "击杀、爆头、连杀、被击杀、低血量等事件由软件通过 GSI 实时检测并变色；运行期额外颜色会由软件动态写入。<br><br>"
        "<b>文件与生效位置</b><br>"
        "1. 这个功能无需额外放资源文件。<br>"
        "2. 规则参数保存在 <code>AppData/Local/FanTool/config.json</code>。<br>"
        "3. 点击「保存 HUD 规则」后会写出 <code>CS2/game/csgo/cfg/fanpai.cfg</code><br>"
        "4. 软件运行期还会按需更新 <code>CS2/game/csgo/cfg/fanpai_hud_runtime.cfg</code><br>"
        "5. 首次使用请在游戏控制台执行 <code>exec fanpai.cfg</code>"
    ),
    "preset_center": (
        "<b>功能说明</b><br>"
